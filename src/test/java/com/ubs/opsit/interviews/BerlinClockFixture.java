...
public class BerlinClockFixture {
    ...
    private TimeConverterImpl berlinClockConverter=new TimeConverterImpl();
    ...
    public void thenTheClockShouldLookLike(String theExpectedBerlinClockOutput) {
              assertThat(berlinClockConverter.convertTime(theTime)).isEqualTo(theExpectedBerlinClockOutput);
    }
}
